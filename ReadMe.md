...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    useRouteMatch lets us use only one path to 

2. How would you explain form validation to someone who has never programmed before?

    It's how you make sure that a form is being filled out correctly. You can set requirements for a specific field and if a user strays from them while fillng out a form an error will pop up and tell you what you're missing/what's wrong with your form. 

3. In 1-2 sentences, define end to end testing.

    End-to-end testing is how you check if your entire app is working correctly. You write out your test code and it will act as the user and go through the app and test all parts of it and send back whether they passed or not.
